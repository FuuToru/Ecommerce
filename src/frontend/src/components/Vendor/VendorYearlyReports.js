...
function VendorYearlyReports(){
    ...
    function fetch_report(baseUrl){
        ...
        .then((data) => {
            console.log(data.show_chart_yearly_order);
            setDates(data.show_chart_yearly_order.date);
            setData(data.show_chart_yearly_order.data);
        })
    }
...
export default VendorYearlyReports;